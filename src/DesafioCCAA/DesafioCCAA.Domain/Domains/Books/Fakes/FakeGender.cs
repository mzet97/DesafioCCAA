...
public static class FakeGender
{
    ...
    public static IEnumerable<Gender> GetValid(int qtd)
    {
        var genderGenerator = new Faker<Gender>(Locale)
            .CustomInstantiator(f =>
            {
                ...
                var name = f.Commerce.Department().ClampLength(1, 150);
        ...
        return genderGenerator.Generate(qtd);
    }

    public static IEnumerable<Gender> GetInvalid(int qtd)
    {
        var invalidGenders = new List<Gender>(qtd);
        ...
        for (int i = 0; i < qtd; i++)
        {
            ...
            string name = baseFaker.Commerce.Department().ClampLength(1, 150);
            ...
            invalidGenders.Add(gender);
        }
        return invalidGenders;
    }

    public static IEnumerable<Gender> GetRandom(int numValid = 5, int numInvalid = 5)
    {
