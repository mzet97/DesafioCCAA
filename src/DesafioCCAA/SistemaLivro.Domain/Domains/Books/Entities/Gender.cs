using SistemaLivro.Domain.Domains.Books.Entities.Validations;
using SistemaLivro.Domain.Domains.Books.Events.Genders;
using SistemaLivro.Shared.Models;

namespace SistemaLivro.Domain.Domains.Books.Entities;
